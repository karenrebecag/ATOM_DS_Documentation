...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@atomchat.io/tokens@1.0.3/build/css/foundation.css">

<!-- Semantic layer -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@atomchat.io/tokens@1.0.3/build/css/semantic.css">

<!-- Component layer -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@atomchat.io/tokens@1.0.3/build/css/components.css">

<!-- Dark theme -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@atomchat.io/tokens@1.0.3/build/css/dark.css">
```
...
**Base URL:**
```
https://cdn.jsdelivr.net/npm/@atomchat.io/tokens@1.0.3/build/css/
```

## Import Patterns

All packages support **multiple import patterns** thanks to improved package.json exports configuration:
...
import tokens from '@atomchat.io/tokens'
// or with full path
import tokens from '@atomchat.io/tokens/build/js/tokens.js'
```
...
:::tip[Import Flexibility]
All packages now support both shorthand and full path imports. Use whichhand for cleaner code, or full paths if you need explicit directory references.
:::
...
|---------|-----------------|----------|
| @atomchat.io/tokens | 1.0.3 | [View on npm](https://www.npmjs.com/package/@atomchat.io/tokens) |
| @atomchat.io/css | 0.2.3 | [View on npm](https://www.npmjs.com/package/@atomchat.io/css) |
| @atomchat.io/animations | 1.2.1 | [View on npm](https://www.npmjs.com/package/@atomchat.io/animations) |
| @atomchat.io/components-astro | 2.0.4 | [View on npm](https://www.npmjs.com/package/@atomchat.io/components-astro) |
